        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <x-form.row>
                    ...
                    <x-form.input name="started_at" type="datetime-local" :value="isset($service->started_at) ? $service->started_at->format('Y-m-d\TH:i') : null" />
                </x-form.row>
                <x-form.row>
                    <x-form.label for="finished_at">{{ __('End date') }}</x-form.label>
                    <x-form.input name="finished_at" type="datetime-local" :value="isset($service->finished_at) ? $service->finished_at->format('Y-m-d\TH:i') : null" />
                </x-form.row>
            </div>
            <div class="col-12 col-md-6">
                <x-form.row>
